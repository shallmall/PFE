...
def main():
    ...
    # 2. Compile
    print("🛠️ Compiling ReputationLedger.sol with solc 0.8.19...")
    ...
    try:
        ...
        print("⚠️ EthereumTesterProvider not available or failed, skipping simulated in-memory execution test.")
